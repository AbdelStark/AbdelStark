...
| Project | What it is |
|---|---|
| [parler](https://github.com/AbdelStark/parler) | Multilingual voice intelligence built on Mistral Voxtral, focused on structured decision logs from French/English meetings. |

### Starknet / zero-knowledge infrastructure
